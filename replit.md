...
- June 16, 2025. Títulos dos capítulos completamente padronizados - removidos TODOS os prefixos ("Introdução –", "Prólogo –", "Epílogo –", "Encerramento –") de todos os 76 capítulos de todos os grimórios, mantendo apenas os nomes essenciais, total de 13 títulos limpos para consistência visual completa
