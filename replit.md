...
- June 16, 2025. Sistema de paginação inteligente implementado - divide conteúdo respeitando estrutura HTML sem cortar elementos, navegação por teclado (setas, Page Up/Down, Home/End), cliques laterais invisíveis, header responsivo com nome do grimório (truncado se necessário), contador de páginas dinâmico
```
