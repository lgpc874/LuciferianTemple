...
- June 16, 2025. Títulos dos capítulos padronizados - removidos prefixos como "Introdução –", "Prólogo –" de todos os capítulos dos grimórios, mantendo apenas os nomes essenciais (ex: "O Primeiro Ardor", "Além das Chamas Fictícias")
