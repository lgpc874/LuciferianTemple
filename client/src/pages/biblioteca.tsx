        ...
        <div className="mb-16">
          ...
          <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-5 xl:grid-cols-6 gap-3 sm:gap-6">
            {Array.isArray(grimoires) && grimoires.map((grimoire: any) => {
              // Use coverImageUrl from database (generated by AI or custom URL)
              // If no coverImageUrl, fallback to SVG covers based on category
              let coverContent = null;
              
              if (grimoire.coverImageUrl) {
                // Use AI-generated or custom cover image
                coverContent = (
                  <img 
                    src={grimoire.coverImageUrl} 
                    alt={`Capa do grimório ${grimoire.title}`}
                ...
                coverContent = grimoireCoverSvgs[coverKey as keyof typeof grimoireCoverSvgs];
              }
